...
//      }
  ...
  //获取rotatedRect中的颜色
  uint8_t get_rect_color(cv::Mat &src, cv::RotatedRect &rect) {
    auto region = rect.boundingRect();
...
//    }
  ...
  void imshowLightBolbs(cv::Mat src, LightBolbs light_bolbs, std::string fileName) {
