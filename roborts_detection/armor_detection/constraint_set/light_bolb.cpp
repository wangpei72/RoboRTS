...
roborts_detection::LightBolb::LightBolb(cv::RotatedRect &rotatedRect, double ratio, uint8_t color) {
  rect = rotatedRect;
  area_ratio = ratio;
...
bool roborts_detection::LightBolb::isVaildLightBolb(const std::vector<cv::Point> &contour,
