...
roborts_decision::Blackboard::Blackboard(const std::string &proto_file_path) :
...
void roborts_decision::Blackboard::ArmorDetectionFeedbackCallback(const roborts_msgs::ArmorDetectionFeedbackConstPtr &feedback) {
...
geometry_msgs::PoseStamped roborts_decision::Blackboard::GetEnemy() const {
  return enemy_pose_;
}

bool roborts_decision::Blackboard::IsEnemyDetected() const {
  ROS_INFO("%s: %d", __FUNCTION__, (int) enemy_detected_);
  return enemy_detected_;
}

void roborts_decision::Blackboard::GoalCallback(const geometry_msgs::PoseStamped::ConstPtr &goal) {
  new_goal_ = true;
  goal_ = *goal;
}

geometry_msgs::PoseStamped roborts_decision::Blackboard::GetGoal() const {
  return goal_;
}

bool roborts_decision::Blackboard::IsNewGoal() {
  if (new_goal_) {
    new_goal_ = false;
    return true;
  } else {
...
double roborts_decision::Blackboard::GetDistance(const geometry_msgs::PoseStamped &pose1,
...
double roborts_decision::Blackboard::GetAngle(const geometry_msgs::PoseStamped &pose1,
                                              const geometry_msgs::PoseStamped &pose2) {
...
const geometry_msgs::PoseStamped roborts_decision::Blackboard::GetChassisMapPose() {
  UpdateChassisPose();
  return chassis_map_pose_;
}

const geometry_msgs::PoseStamped roborts_decision::Blackboard::GetGimbalMapPose() {
  UpdateGimbalPose();
  return gimbal_map_pose_;
}

const std::shared_ptr<roborts_decision::Blackboard::CostMap> roborts_decision::Blackboard::GetCostMap() {
  return costmap_ptr_;
}

const roborts_decision::Blackboard::CostMap2D* roborts_decision::Blackboard::GetCostMap2D() {
  return costmap_2d_;
}

const unsigned char* roborts_decision::Blackboard::GetCharMap() {
  return charmap_;
}

void roborts_decision::Blackboard::UpdateChassisPose() {
...
void roborts_decision::Blackboard::UpdateGimbalPose() {
